  ...
  return (
    <div className=" flex flex-col items-center bg-[url('/src/assets/uno.jpg')] mx-auto py-12 px-4">
      ...
      <main className="flex flex-col items-center justify-center m-4 gap-4">
        <section className="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 py-8 px-4 ">
          <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            ...
            <div className="grid grid-cols-2 gap-4 mt-8">
              <img src="../../assets/accessim_logo_black.png"></img>
              <div className="bg-white dark:bg-gray-800 items-center py-8 px-4 mx-auto max-w-screen-xl">
                <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-700 dark:border-gray-600">
                  <div>
        ...
        <section className="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 py-8 px-4">
          <div className="gap-16 items-center md:py-8 md:px-4 mx-auto max-w-screen-xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 lg:py-16 lg:px-6">
            <div className="h-[575px] w-[312px]">
              <img
          ...
          <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
              <div className="flex flex-row items-center gap-4 font-light text-gray-500 sm:text-lg dark:text-gray-400">
                <div className="bg-orange-500 rounded-full  px-2 py-2 items-center ">
                  <img
                    src="../../src\assets\newaccount.svg"
                    className="h-[16.25px] w-[16.25px] "
                  ></img>
                </div>
                <Link to="/register" className="mb-4 font-bold">
                  Registrate
                </Link>
              </div>
              <div className="flex flex-row items-center gap-4 font-light text-gray-500 sm:text-lg dark:text-gray-400">
